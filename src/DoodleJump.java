...
public class DoodleJump extends Game {
	...
	public DoodleJump(String name, int width, int height, int scale) throws IOException {
		...
		//add(doodle);
		int yPos = height-50;
		for(int i = 0; i < 30; i++) bricks.add(new Brick(brick_bm, Util.random(0, width-brick_bm.getWidth()), yPos -= Util.random(40, 120)));
	...
	public static void main(String[] args) throws IOException {
		new DoodleJump("Doodle Jump", 640, 960, 1).start();
	}
